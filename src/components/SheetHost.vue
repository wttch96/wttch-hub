...
.sheet { width: 100%; max-height: min(78vh, 640px); overflow: auto; border: 1px solid var(--hairline); border-bottom: 0; border-radius: 14px 14px 0 0; background: var(--card-bg); box-shadow: 0 -12px 36px rgba(0, 0, 0, .16); -webkit-backdrop-filter: blur(22px); backdrop-filter: blur(22px); }
...
.sheet-head button:hover { background: var(--accent-weak); color: var(--text); }
